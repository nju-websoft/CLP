...
if __name__ == '__main__':
    ...
    # training control
    parser.add_argument('-dataset', dest='dataset', default='WIKI-YAGO',help='dataset name, DBPedia-FB15K237, Wikidata-YAGO3')

    parser.add_argument('-load_checkpoint', dest='load_checkpoint',default='./checkpoint/WIKI-YAGO-TransE-lookup_attn-256-12.0-ea_expand_training-RPG-0.3--0.0005-2024-neg_ratio-256different_ea_rate_CLP/',help='path to save model')
    ...
    parser.add_argument('-gpu', dest='gpu', default=2)
    ...
    parser.add_argument('-lambda_1', dest='lambda_1', default=0.8, help='')
    ...
    if not args.RPG:
        ...
        args.ea_expand_training = False
        args.encoder = 'mergeSameAs'
    if args.use_attn:
        args.encoder = 'lookup_attn'
    if 'DBPedia' in args.dataset:
        args.margin = 9.0
    else:
        args.margin = 12.0
